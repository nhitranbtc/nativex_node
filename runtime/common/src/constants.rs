pub mod currency {
	...
	pub const TOKEN_SYMBOL: &str = "NATIVEX";
	pub const NATIVEX: Balance = DOLLARS;
...
pub mod time {
	...
	// Attempting to do so will brick block duration.
	...
	// Attemping to do so will brick block duration.
